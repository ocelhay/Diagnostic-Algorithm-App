...
shinyUI(fluidPage(
  ...
  sidebarLayout(
    ...
    mainPanel(
      ...
      h2("Algorithms for Best Possible Diagnosis"),
      ...
      h2("Proportion of Correctly Diagnosed"),
       plotOutput("plot_cd"),
       p("Each bar depicts the proportion of each disease correctly dignosed by the best algorithm."),
      hr(),
      h2("Positive Predictive Value"),
       plotOutput("plot_ppv"),
       p("Each bar depicts the postive predictive value for each disease in the best algorithm."),
      hr(),
      h2("Algorithm"),
