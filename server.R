...
shinyServer(function(input, output, session) {
  ...
  observeEvent(input$scenario, {
    ...
    if(input$scenario == 'none'){
      ...
      updateNumericInput(session, "prevalence_dis_1", value = 0)
      updateNumericInput(session, "prevalence_dis_2", value = 0)
      updateNumericInput(session, "prevalence_dis_3", value = 0)
      updateNumericInput(session, "prevalence_dis_4", value = 0)
      updateNumericInput(session, "prevalence_dis_5", value = 0)
      
      updateNumericInput(session, "sensitivity_dis_1", value = 95)
      updateNumericInput(session, "sensitivity_dis_2", value = 95)
      updateNumericInput(session, "sensitivity_dis_3", value = 95)
      updateNumericInput(session, "sensitivity_dis_4", value = 95)
      updateNumericInput(session, "sensitivity_dis_5", value = 95)
      
      updateNumericInput(session, "specificity_dis_1", value = 95)
      updateNumericInput(session, "specificity_dis_2", value = 95)
      updateNumericInput(session, "specificity_dis_3", value = 95)
      updateNumericInput(session, "specificity_dis_4", value = 95)
      updateNumericInput(session, "specificity_dis_5", value = 95)
    }
    ...
    if(input$scenario == 'East Africa'){
      ...
      updateNumericInput(session, "prevalence_dis_2", value = 0)
      updateNumericInput(session, "prevalence_dis_3", value = 0)
      updateNumericInput(session, "prevalence_dis_4", value = 0.3)
      updateNumericInput(session, "prevalence_dis_5", value = 8.8)
    }
  })
  ...
  output$plot_algo <- renderPlot({
    ...
    ggplot(df, aes(x = reorder(Algorithm, -`Correctly Diagnosed`), y = `Correctly Diagnosed Test`, fill = `Test Name`, group = -Position)) +
